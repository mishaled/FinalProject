...
namespace DAL.IntegrationTests
{
    ...
    public class EdgePathToCypherQueryConverterTests
    {
        ...
        public void Convert_OneEdge_ShouldConvertCorrectly()
        {
            ...
            Assert.AreEqual(query, "match(n0:Node { id: 1, label: 1})-[:CONNECTED_TO {label: 1 }]-(n1 {id: 2, label: 2}) return DISTINCT n0.graphId");
        }
        ...
        public void Convert_TwoEdgesInCorrectOrder_ShouldConvertCorrectly()
        {
            ...
            Assert.AreEqual(query, "match(n0:Node { id: 1, label: 1})-[:CONNECTED_TO {label: 1 }]-(n1 {id: 2, label: 2})-[:CONNECTED_TO {label: 2 }]-(n2 {id: 3, label: 3}) return DISTINCT n0.graphId");
        }
